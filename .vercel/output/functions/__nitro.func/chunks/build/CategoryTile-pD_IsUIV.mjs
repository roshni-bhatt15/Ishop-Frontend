    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_ImageLazy, {
          "lazy-src": _ctx.thumbImageURL($props.category),
          title: $props.category.title,
          alt: $props.category.title
        }, null, _parent2, _scopeId));
        _push2(`</div><h5 class="item-title ellipsis ellipsis-1"${_scopeId}>${ssrInterpolate($props.category.title)}</h5>`);
      } else {
        return [
          ...
          createVNode("h5", { class: "item-title ellipsis ellipsis-1" }, toDisplayString($props.category.title), 1)
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CategoryTile.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const CategoryTile = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { CategoryTile as default };
//# sourceMappingURL=CategoryTile-pD_IsUIV.mjs.map
