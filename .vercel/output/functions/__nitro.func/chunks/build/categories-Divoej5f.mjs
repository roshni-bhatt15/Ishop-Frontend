...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_category_listing_layout, mergeProps({
        "sub-categories-map": unref(subCategoriesMap),
        type: "subCategory"
      }, _attrs), null, _parent));
    };
  }
...
//# sourceMappingURL=categories-Divoej5f.mjs.map
