...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_nuxt_link, mergeProps({
    ...
    to: _ctx.categoryLink($props.subCategory),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_ImageLazy, {
          "lazy-src": _ctx.thumbImageURL($props.subCategory),
          title: $props.subCategory.title,
          alt: $props.subCategory.title
        }, null, _parent2, _scopeId));
        _push2(`</div><h5 class="item-title ellipsis ellipsis-1"${_scopeId}>${ssrInterpolate($props.subCategory.title)}</h5>`);
      } else {
        return [
          ...
          createVNode("h5", { class: "item-title ellipsis ellipsis-1" }, toDisplayString($props.subCategory.title), 1)
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SubCategoryTile.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { __nuxt_component_2 as default };
//# sourceMappingURL=SubCategoryTile-YC2vuUC-.mjs.map
