...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const slugText = computed(() => {
      var _a2;
      return slugToText((_a2 = route == null ? void 0 : route.params) == null ? void 0 : _a2.main);
    });
    useHead(pageMeta({
      ...site_setting.value,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_listing_layout, mergeProps({
        "result-title": slugText.value,
        "product-params": productParams.value
      }, _attrs), null, _parent));
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/[main]/products/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-Btz0Y90U.mjs.map
