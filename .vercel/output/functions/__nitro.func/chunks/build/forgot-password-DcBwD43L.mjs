...
import { u as useLanguageStore, a as useCommonStore, c as useI18n, d as useHead, h as __nuxt_component_0$1 } from './server.mjs';
import { ref, watch, computed, unref, withCtx, createTextVNode, toDisplayString, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(emailSubmitted) || !unref(passwordUpdated)) {
        _push(`<form>`);
        ...
        _push(`</div>`);
        if (unref(emailSubmitted)) {
          _push(`<!--[--><div class="${ssrRenderClass([{ invalid: !unref(code) && unref(hasFormError) }, "input-wrap"])}"><label>${ssrInterpolate(_ctx.$t("forgotPassword.code"))}</label><div class="icon-input"><i class="icon code-icon"></i><input type="text"${ssrRenderAttr("value", unref(code))}${ssrRenderAttr("placeholder", _ctx.$t("forgotPassword.codeFrom"))}></div>`);
          if (!unref(code) && unref(hasFormError)) {
            _push(`<span class="error">${ssrInterpolate(_ctx.$t("addressPopup.isRequired", { type: _ctx.$t("forgotPassword.code") }))} Code is Required </span>`);
          } else {
            _push(`<!---->`);
          }
        ...
        _push(`<div class="flex right no-space">`);
        ...
        _push(`</div></form>`);
      } else if (unref(emailSubmitted) && unref(passwordUpdated)) {
...
//# sourceMappingURL=forgot-password-DcBwD43L.mjs.map
