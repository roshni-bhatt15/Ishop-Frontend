import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, createElementBlock, h, resolveComponent, hasInjectionContext, inject, toRef, ref, computed, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, withCtx, getCurrentScope, toDisplayString as toDisplayString$1, createTextVNode, withModifiers, nextTick, mergeProps, useSSRContext } from 'vue';
import { c as createError$1, k as destr, l as klona, m as sanitizeStatusCode, n as getRequestHeader, o as isEqual$1, q as getContext, r as setCookie, v as getCookie, w as deleteCookie, $ as $fetch, x as createHooks, y as executeAsync, z as toRouteMatcher, A as createRouter$1, B as defu, C as getRequestProtocol, D as getRequestHeaders } from '../_/nitro.mjs';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttr, ssrInterpolate } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    meta: { ...__nuxt_page_meta$x || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./cart-Bcqbw0im.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: { ...__nuxt_page_meta$w || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./index-bimBWIdB.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: { ...__nuxt_page_meta$v || {}, ...{ "middleware": ["common-middleware", "non-auth"] } },
    component: () => import('./login-CPFN_Xg4.mjs')
  },
  {
    name: "brands",
    path: "/brands",
    meta: { ...__nuxt_page_meta$u || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./brands-Btq1MiMo.mjs')
  },
  {
    name: "search",
    path: "/search",
    meta: { ...__nuxt_page_meta$t || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./search-B6UUNBz9.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    meta: { ...__nuxt_page_meta$s || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./checkout-ZfR99rSZ.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: { ...__nuxt_page_meta$r || {}, ...{ "middleware": ["common-middleware", "non-auth"] } },
    component: () => import('./register-CSGRqMsA.mjs')
  },
  {
    name: "shipping",
    path: "/shipping",
    meta: { ...__nuxt_page_meta$q || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./shipping-BxXQY-kR.mjs')
  },
  {
    name: "categories",
    path: "/categories",
    meta: { ...__nuxt_page_meta$p || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./categories-Divoej5f.mjs')
  },
  {
    name: "page-slug",
    path: "/page/:slug()",
    meta: { ...__nuxt_page_meta$o || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./_slug_-BlytNQe6.mjs')
  },
  {
    name: "shop-slug",
    path: "/shop/:slug()",
    meta: { ...__nuxt_page_meta$n || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./_slug_-iTAjoK-b.mjs')
  },
  {
    name: "track-order",
    path: "/track-order",
    meta: { ...__nuxt_page_meta$m || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./track-order-CUKk08Kd.mjs')
  },
  {
    name: "user-orders",
    path: "/user/orders",
    meta: { ...__nuxt_page_meta$l || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./orders-DkPVqtxz.mjs')
  },
  {
    name: "user-profile",
    path: "/user/profile",
    meta: { ...__nuxt_page_meta$k || {}, ...{ "middleware": ["common-middleware", "auth"] } },
    component: () => import('./profile-HGXBwh-O.mjs')
  },
  {
    name: "user-compared",
    path: "/user/compared",
    meta: { ...__nuxt_page_meta$j || {}, ...{ "middleware": ["common-middleware", "auth"] } },
    component: () => import('./compared-wvwshrcA.mjs')
  },
  {
    name: "user-vouchers",
    path: "/user/vouchers",
    meta: { ...__nuxt_page_meta$i || {}, ...{ "middleware": ["common-middleware", "auth"] } },
    component: () => import('./vouchers-CFzoBc3Y.mjs')
  },
  {
    name: "seller-sign-up",
    path: "/seller/sign-up",
    meta: { ...__nuxt_page_meta$h || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./sign-up-BPv8WnUp.mjs')
  },
  {
    name: "user-addresses",
    path: "/user/addresses",
    meta: { ...__nuxt_page_meta$g || {}, ...{ "middleware": ["common-middleware", "auth"] } },
    component: () => import('./addresses-DPgXqZq6.mjs')
  },
  {
    name: "user-following",
    path: "/user/following",
    meta: { ...__nuxt_page_meta$f || {}, ...{ "middleware": ["common-middleware", "auth"] } },
    component: () => import('./following-D5hl-uDz.mjs')
  },
  {
    name: "user-wishlists",
    path: "/user/wishlists",
    meta: { ...__nuxt_page_meta$e || {}, ...{ "middleware": ["common-middleware", "auth"] } },
    component: () => import('./wishlists-G_qARTKq.mjs')
  },
  {
    name: "flash-sale-id",
    path: "/flash-sale/:id()",
    meta: { ...__nuxt_page_meta$d || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./_id_-B7wRtQ2k.mjs')
  },
  {
    name: "forgot-password",
    path: "/forgot-password",
    meta: { ...__nuxt_page_meta$c || {}, ...{ "middleware": ["common-middleware", "non-auth"] } },
    component: () => import('./forgot-password-DcBwD43L.mjs')
  },
  {
    name: "seller-register",
    path: "/seller/register",
    meta: { ...__nuxt_page_meta$b || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./register-Db3GSMeI.mjs')
  },
  {
    name: "social-callback",
    path: "/social-callback",
    meta: { ...__nuxt_page_meta$a || {}, ...{ "middleware": ["common-middleware", "non-auth"] } },
    component: () => import('./social-callback-f2Dn04Fo.mjs')
  },
  {
    name: "user-order-id",
    path: "/user/order/:id()",
    meta: { ...__nuxt_page_meta$9 || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./_id_-OOUCLbdy.mjs')
  },
  {
    name: "flash-sale",
    path: "/flash-sale",
    meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./index-pgUwVIkI.mjs')
  },
  {
    name: "razorpay-callback",
    path: "/razorpay-callback",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": ["common-middleware", "auth"] } },
    component: () => import('./razorpay-callback-DxhlmGD3.mjs')
  },
  {
    name: "main-brand",
    path: "/:main()/brand",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./index-4bZKBui5.mjs')
  },
  {
    name: "main-product-id",
    path: "/:main()/product/:id()",
    meta: { ...__nuxt_page_meta$5 || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./_id_-CBYWdCGi.mjs')
  },
  {
    name: "payfast-cancel-id",
    path: "/payfast/cancel/:id()",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./_id_-BLuaAhOY.mjs')
  },
  {
    name: "payfast-return-id",
    path: "/payfast/return/:id()",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./_id_-C068YV3A.mjs')
  },
  {
    name: "all-category",
    path: "/all/:category()",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./index-DuBSt11d.mjs')
  },
  {
    name: "main-products",
    path: "/:main()/products",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./index-Btz0Y90U.mjs')
  },
  {
    name: "main-collection",
    path: "/:main()/collection",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": ["common-middleware"] } },
    component: () => import('./index-DUX7ovwP.mjs')
  }
];
...
const namedMiddleware = {
  auth: () => import('./auth-BcE-S1W-.mjs'),
  "common-middleware": () => import('./common-middleware-5QOuuMa1.mjs'),
  "non-auth": () => import('./non-auth-BqbOLiGi.mjs')
};
...
const vueI18nConfigs = [
  () => import(
    './config-Bq9jKx5t.mjs'
    /* webpackChunkName: "config_config_46js_a46af71a" */
  )
];
...
async function navigate({ nuxt, locale, route, redirectPath }, enableNavigate = false) {
  ...
  if (differentDomains) {
    const state2 = useRedirectState();
    if (state2.value && state2.value !== redirectPath) {
      {
        state2.value = redirectPath;
      }
    }
...
const dompurify_Gto63hYtQtp6eHmNKWR3qTdSTAJ0kw3EJVHpTXCPPwM = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const Service = {
  async deleteRequest(api2, bearer) {
    let header = { "Authorization": `Bearer ${bearer}` };
    const fetchClient = createFetchClient(header);
    const result = await fetchClient(api2, {
      method: "DELETE"
    });
    if ((result == null ? void 0 : result.status) === 401) {
      return Promise.reject({ status: 401, message: "" });
    }
    return result.json();
  },
  async getRequest(api2, bearer, lang = null) {
    let header = { "Authorization": `Bearer ${bearer}` };
    if (lang) {
    ...
    return result == null ? void 0 : result.json();
  },
  async postRequest(api2, params, bearer, lang = null) {
    let header = { "Authorization": `Bearer ${bearer}` };
    if (lang) {
      header = { ...header, ...{ "Language": lang } };
    }
  ...
  async unAuthPost(api2, params, lang = null) {
    let header = {};
    if (lang) {
      header = { ...header, ...{ "Language": lang } };
    }
  ...
  async unAuthGet(api2, lang = null) {
    let header = {};
    if (lang) {
      header = { ...header, ...{ "Language": lang } };
    }
...
function useUtils() {
  ...
  const collectionLink = (item) => {
    if (item) {
      return `/${item == null ? void 0 : item.slug}/collection?collection=${item == null ? void 0 : item.id}`;
    }
  };
  const productLink = (item) => {
    if (item) {
      return `/${item == null ? void 0 : item.slug}/product/${item == null ? void 0 : item.id}`;
    }
  };
  const categoryLink = (item) => {
    if (item) {
      return `/all/${item == null ? void 0 : item.slug}`;
    }
  };
  const pageLink = (page) => {
  ...
  const sourceUrl = (item, query = "home_spm") => {
    ...
    if (parseInt(item == null ? void 0 : item.source_type) === parseInt(productSourcesIn.URL)) {
      return ((_a = item == null ? void 0 : item.url) == null ? void 0 : _a.toString()) || "/";
    }
    if (item) {
      return `/${item == null ? void 0 : item.slug}/products?${query}=${item.id}`;
    }
  };
  const getTimeZone = () => {
    var _a, _b;
    const tz = (_b = (_a = Intl.DateTimeFormat()) == null ? void 0 : _a.resolvedOptions()) == null ? void 0 : _b.timeZone;
    if (tz === "Asia/Calcutta") return "Asia/Kolkata";
    return tz;
  };
  const dataFromObject = (data, key, defaultData = "") => {
    return data && data[key] !== void 0 && data[key] ? data[key] : defaultData;
  };
  const getUrl = (item) => {
    return (item == null ? void 0 : item.url) || "/";
  };
  const getTitle = (item) => {
...
const actions$1 = {
  ...
  setCommonData(data) {
    var _a, _b;
    const common = data;
    this.current_year = (/* @__PURE__ */ new Date()).getFullYear();
    if (common == null ? void 0 : common.setting) {
      this.setting = common == null ? void 0 : common.setting;
      this.location = {
        countryCode: (_a = common == null ? void 0 : common.setting) == null ? void 0 : _a.default_country,
        region: (_b = common == null ? void 0 : common.setting) == null ? void 0 : _b.default_state
      };
      this.currencyIcon = this.setting.currency_icon;
    }
    if (common == null ? void 0 : common.site_setting) {
    ...
    this.headerLinks = common == null ? void 0 : common.header_links;
    this.popupBanner = common == null ? void 0 : common.popup_banner;
    this.topBanner = common == null ? void 0 : common.top_banner;
    this.categories = common == null ? void 0 : common.categories;
    this.customScripts = common == null ? void 0 : common.custom_scripts;
    this.services = common == null ? void 0 : common.services;
    this.about = common == null ? void 0 : common.about;
    this.payment = common == null ? void 0 : common.payment;
    this.social = common == null ? void 0 : common.social;
  ...
  setSubCatMap(categories) {
    ...
    categories == null ? void 0 : categories.forEach((i) => {
      var _a;
      (_a = i == null ? void 0 : i.public_sub_categories) == null ? void 0 : _a.forEach((j) => {
        subCategoriesMap[j.id] = { title: i.id, slug: i.slug };
      });
    });
    this.subCategoriesMap = subCategoriesMap;
  },
  async postRequest({ params, api: api2, lang }) {
    try {
      const authStore = useAuthStore();
      const { token } = storeToRefs(authStore);
      return await Service.postRequest(json.api[api2], params, token.value, lang);
    } catch (e) {
  ...
  async deleteRequest({ api: api2, params }) {
    const authStore = useAuthStore();
    const { token } = storeToRefs(authStore);
    try {
      return await Service.deleteRequest(`${json.api[api2]}${params}`, token.value);
    } catch (e) {
      if ((e == null ? void 0 : e.status) === 401) {
        logUserOut();
        return navigateTo("/login");
  ...
  async unAuthPost({ params, api: api2, lang }) {
    try {
      return await Service.unAuthPost(json.api[api2], params, lang);
    } catch (e) {
      showError({
        statusCode: 400,
        message: e.message
  ...
  async unAuthGet({ api: api2, params, lang }) {
    try {
      const data = await Service.unAuthGet(`${json.api[api2]}${params}`, lang);
  ...
  async bgGetRequest({ params, api: api2, lang }) {
    try {
      const authStore = useAuthStore();
      const { token } = storeToRefs(authStore);
      return await Service.getRequest(`${json.api[api2]}${params}`, token.value, lang);
    } catch (e) {
      if ((e == null ? void 0 : e.status) === 401) {
        logUserOut();
        return navigateTo("/login");
  ...
  async getRequest({ params, api: api2, lang }) {
    const authStore = useAuthStore();
    const { token } = storeToRefs(authStore);
    const { logUserOut: logUserOut2 } = authStore;
    try {
      const data = await Service.getRequest(`${json.api[api2]}${params}`, token.value, lang);
...
const actions = {
  ...
  async setLocalMessages(i18n) {
    var _a, _b;
    if (!(this == null ? void 0 : this.langData)) {
      await this.getLangData(i18n);
    } else if (!((_a = this == null ? void 0 : this.currentLanguage) == null ? void 0 : _a.predefined)) {
      i18n.setLocaleMessage((_b = this == null ? void 0 : this.currentLanguage) == null ? void 0 : _b.code, this == null ? void 0 : this.langData);
    }
  },
  async getLangData() {
    var _a, _b;
    if (!((_a = this == null ? void 0 : this.currentLanguage) == null ? void 0 : _a.predefined)) {
      try {
        const fullUrl = `${json.api.localization}?${prepareGetUrl({
          locale_code: (_b = this == null ? void 0 : this.currentLanguage) == null ? void 0 : _b.code
        })}`;
        const data = await Service.unAuthGet(fullUrl);
        if ((data == null ? void 0 : data.status) && (data == null ? void 0 : data.status) === 200) {
...
const init_server_9_9s6kKqqMYkFsThKv2YxTFTlZbGwQq09qgBPnGuBRQ = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  var _a;
  let __temp, __restore;
  try {
    const config = /* @__PURE__ */ useRuntimeConfig();
    ...
    const response = ([__temp, __restore] = executeAsync(() => unAuthGet({ api: "common", params: "", lang: cookieLang.value })), __temp = await __temp, __restore(), __temp);
    ...
    if (responseData == null ? void 0 : responseData.default_language) {
    ...
    if (cookieLang.value !== ((_a = defaultLanguage == null ? void 0 : defaultLanguage.value) == null ? void 0 : _a.code)) {
      setLangCode(cookieLang.value);
    } else {
      setLangCode(null);
    }
    ;
    [__temp, __restore] = executeAsync(() => getLangData()), await __temp, __restore();
...
const outsideClick = {
  beforeMount(el, binding) {
    ...
    (void 0).addEventListener("click", el.clickOutsideEvent);
  },
  unmounted(el) {
    (void 0).removeEventListener("click", el.clickOutsideEvent);
    el.clickOutsideHandler = null;
  }
};
const outside_click_directive_l7wtJE4BeG_ceasQ_SXlrGMM3ndl6XtZAM_RxxtJvIY = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const plugins = [
  ...
  dompurify_Gto63hYtQtp6eHmNKWR3qTdSTAJ0kw3EJVHpTXCPPwM,
  init_server_9_9s6kKqqMYkFsThKv2YxTFTlZbGwQq09qgBPnGuBRQ,
  outside_click_directive_l7wtJE4BeG_ceasQ_SXlrGMM3ndl6XtZAM_RxxtJvIY,
  ssg_detect_IpHCGcQQ_IR5Rl99qyukWoMA9fJGfuTYyoksTzy81cs
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-kKbUerLl.mjs').then((m) => m.default || m)),
  empty: defineAsyncComponent(() => import('./empty-CTUKik_G.mjs').then((m) => m.default || m))
};
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_VitePwaManifest = __nuxt_component_1;
...
const _imports_0 = "" + __buildAssetsURL("error.DuR8RTpt.png");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container-fluid mtb-20 mtb-sm-15" data-v-e014ef42${_scopeId}><div class="flex error-wrapper reverse" data-v-e014ef42${_scopeId}><div class="img-wrap mb-sm-20 mlr-xs-auto" data-v-e014ef42${_scopeId}><img${ssrRenderAttr("src", _imports_0)} alt="Error image" height="50" width="50" data-v-e014ef42${_scopeId}></div><div class="mr-50 mr-sm" data-v-e014ef42${_scopeId}><h1 class="big-title" data-v-e014ef42${_scopeId}>${ssrInterpolate(_ctx.$t("error.sorry"))}</h1><h2 class="mb-15" data-v-e014ef42${_scopeId}>${ssrInterpolate(__props.error.message)}</h2><h4 class="mb-30" data-v-e014ef42${_scopeId}>${ssrInterpolate(_ctx.$t("error.try"))} <button aria-label="submit" class="outline-btn plr-25 mlr-5" data-v-e014ef42${_scopeId}>${ssrInterpolate(_ctx.$t("error.reload"))}</button> ${ssrInterpolate(_ctx.$t("error.or"))} `);
            _push2(ssrRenderComponent(_component_nuxt_link, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong data-v-e014ef42${_scopeId2}>${ssrInterpolate(_ctx.$t("error.goHome"))}</strong>`);
                } else {
                  return [
                    createVNode("strong", null, toDisplayString$1(_ctx.$t("error.goHome")), 1)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`</h4></div></div></div>`);
          } else {
            return [
              createVNode("div", { class: "container-fluid mtb-20 mtb-sm-15" }, [
                createVNode("div", { class: "flex error-wrapper reverse" }, [
                  createVNode("div", { class: "img-wrap mb-sm-20 mlr-xs-auto" }, [
                    createVNode("img", {
                      src: _imports_0,
                      alt: "Error image",
                      height: "50",
                  ...
                  createVNode("div", { class: "mr-50 mr-sm" }, [
                    createVNode("h1", { class: "big-title" }, toDisplayString$1(_ctx.$t("error.sorry")), 1),
                    createVNode("h2", { class: "mb-15" }, toDisplayString$1(__props.error.message), 1),
                    createVNode("h4", { class: "mb-30" }, [
                      createTextVNode(toDisplayString$1(_ctx.$t("error.try")) + " ", 1),
                      createVNode("button", {
                        "aria-label": "submit",
                        class: "outline-btn plr-25 mlr-5",
                        onClick: withModifiers(reload, ["prevent"])
                      }, toDisplayString$1(_ctx.$t("error.reload")), 1),
                      createTextVNode(" " + toDisplayString$1(_ctx.$t("error.or")) + " ", 1),
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e014ef42"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
export { Service as S, __nuxt_component_0$2 as _, useCommonStore as a, useAuthStore as b, useI18n as c, useHead as d, entry$1 as default, useRouter as e, useUtils as f, useConstants as g, __nuxt_component_0$1 as h, useRoute as i, _export_sfc as j, json as k, useNuxtApp as l, asyncDataDefaults as m, createError as n, useIndexStore as o, prepareGetUrl as p, navigateTo as q, outsideClick as r, showError as s, defineNuxtRouteMiddleware as t, useLanguageStore as u, useCookie as v, useRuntimeConfig as w };
