...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const totalPage = computed(() => {
      var _a;
      return (_a = allWishlist.value) == null ? void 0 : _a.last_page;
    });
    const currentWishLists = computed(() => {
      var _a;
      return (_a = allWishlist.value) == null ? void 0 : _a.data;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_account_layout, mergeProps({
        ...
        onClickedWishlists: loadData,
        class: "flow-hidden"
      }, _attrs), {
        rightArea: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(``);
            if (unref(fetchingWishlistData)) {
            ...
            if (unref(currentWishLists) && !unref(currentWishLists).length) {
              _push2(`<div class="info-msg"${_scopeId}>${ssrInterpolate(_ctx.$t("wishlist.noWishlist"))}</div>`);
            } else {
              ...
              if (unref(fetchingWishlistData)) {
                ...
                _push2(`<!--[-->`);
                ssrRenderList(unref(currentWishLists), (value, index) => {
                  _push2(ssrRenderComponent(_component_product_tile, {
                    key: index,
            ...
            return [
              createVNode(Transition, {
                ...
                default: withCtx(() => [
                  unref(fetchingWishlistData) ? (openBlock(), createBlock("div", {
                    key: 0,
              ...
              unref(currentWishLists) && !unref(currentWishLists).length ? (openBlock(), createBlock("div", {
                key: 0,
                class: "info-msg"
              }, toDisplayString(_ctx.$t("wishlist.noWishlist")), 1)) : (openBlock(), createBlock("div", {
                key: 1,
                class: "area"
              }, [
                createVNode("div", { class: "area-content" }, [
                  createVNode("div", { class: "tile-container" }, [
                    ...
                    ])) : (openBlock(true), createBlock(Fragment, { key: 1 }, renderList(unref(currentWishLists), (value, index) => {
                      return openBlock(), createBlock(_component_product_tile, {
                        key: index,
                        product: value.product
                      }, null, 8, ["product"]);
                    }), 128))
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/user/wishlists.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=wishlists-G_qARTKq.mjs.map
