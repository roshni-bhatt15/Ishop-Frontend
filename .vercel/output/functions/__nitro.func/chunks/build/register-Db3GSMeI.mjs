...
import __nuxt_component_1$1 from './PasswordField-DoDe4gf3.mjs';
import _sfc_main$1 from './AjaxButton-DzViXcHL.mjs';
import { a as useCommonStore, u as useLanguageStore, d as useHead, h as __nuxt_component_0$1 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_password_field = __nuxt_component_1$1;
      const _component_ajax_button = _sfc_main$1;
      const _component_nuxt_link = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      if (!unref(emailVerificationForm) && !unref(verified)) {
        _push(`<form class="seller-form user-form"><div class="center-text mb-30"><h6>${ssrInterpolate(_ctx.$t("date.reg"))}</h6><h1 class="mt-10 mb-20 color-primary">${ssrInterpolate(_ctx.$t("date.sr"))}</h1><p>${ssrInterpolate(_ctx.$t("date.pm"))}</p></div>`);
        _push(ssrRenderComponent(_component_error_handler, { errors: unref(errors) }, null, _parent));
        _push(`<div class="${ssrRenderClass([{ invalid: !unref(name) && unref(hasFormError) }, "input-wrap"])}"><label>${ssrInterpolate(_ctx.$t("addressPopup.name"))}</label><div class="icon-input"><i class="icon user-icon"></i><input type="text"${ssrRenderAttr("value", unref(name))}${ssrRenderAttr("placeholder", _ctx.$t("contact.your", { type: _ctx.$t("contact.name") }))}></div>`);
        ...
        _push(`</div><div class="${ssrRenderClass([{ invalid: !unref(storeName) && unref(hasFormError) }, "input-wrap"])}"><label>${ssrInterpolate(_ctx.$t("date.sn"))}</label><div class="icon-input"><i class="icon user-icon"></i><input type="text"${ssrRenderAttr("value", unref(storeName))}${ssrRenderAttr("placeholder", _ctx.$t("date.sn"))}></div>`);
        if (!unref(storeName) && unref(hasFormError)) {
          _push(`<span class="error">${ssrInterpolate(_ctx.$t("addressPopup.isRequired", { type: _ctx.$t("date.sn") }))}</span>`);
        } else {
          _push(`<!---->`);
        }
      ...
      if (unref(emailVerificationForm) && !unref(verified)) {
        _push(`<form class="seller-form user-form"><div class="center-text mb-30"><h1 class="mt-10 mb-20 color-primary">Verification</h1><p>${ssrInterpolate(_ctx.$t("register.sentEmail"))}</p></div>`);
        _push(ssrRenderComponent(_component_error_handler, { errors: unref(errors) }, null, _parent));
        _push(`<div class="${ssrRenderClass([{ invalid: !unref(code) && unref(hasFormError) }, "input-wrap"])}"><label>${ssrInterpolate(_ctx.$t("forgotPassword.code"))}</label><input type="text"${ssrRenderAttr("value", unref(code))}${ssrRenderAttr("placeholder", _ctx.$t("forgotPassword.codeFrom"))}>`);
        ...
        _push(`<div class="seller-form user-form"><h1 class="mt-10 mb-20 color-primary">${ssrInterpolate(_ctx.$t("contact.success"))}!!!</h1><p class="mb-15"><b>${ssrInterpolate(_ctx.$t("forgotPassword.congratulations"))}</b>. ${ssrInterpolate(_ctx.$t("forgotPassword.verified"))}</p><p class="mb-15">${ssrInterpolate(_ctx.$t("date.yw"))}</p><p class="mb-15">`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(_ctx.$t("date.gh"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(_ctx.$t("date.gh")), 1)
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/seller/register.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=register-Db3GSMeI.mjs.map
