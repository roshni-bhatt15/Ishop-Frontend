  ...
  <div class="container-fluid mtb-20 mtb-sm-15">
    <div class="order-wrapper">
      <ul class="left-sidebar">
        ...
        <li :class="{ active: activeRoute === 'addresses' }">
          <nuxt-link
            to="/user/addresses"
        ...
        <li :class="{ active: activeRoute === 'vouchers' }">
          <nuxt-link
            to="/user/vouchers"
        ...
        <li :class="{ active: activeRoute === 'orders' }">
          <nuxt-link
            to="/user/orders"
        ...
        <li :class="{ active: activeRoute === 'following' }">
          <nuxt-link
            to="/user/following"
        ...
        <li :class="{ active: activeRoute === 'wishlists' }">
          <nuxt-link
            to="/user/wishlists"
        ...
        <li :class="{ active: activeRoute === 'compared' }">
          <nuxt-link
            to="/user/compared"
