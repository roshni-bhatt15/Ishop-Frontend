<template>
  <div class="main-slider">
    <div class="h-100" v-if="slider && slider.main.length">
      <div
      ...
      >
        <div class="left flow-hidden">
          <div class="pos-rel">
            ...
            <img
              ...
              height="100"
              width="100"
              :src="utils.getImageURL(slider.main[0].image)"
            />
          </div>
        </div>
        <!--left-->
        <div v-if="rightTop || rightBottom" class="right">
          ...
          >
            <img
              :src="utils.getImageURL(rightTop.image)"
              height="100"
              width="100"
              :alt="$t('invent.si')"
            />
          ...
          >
            <img
              :src="utils.getImageURL(rightBottom.image)"
              height="100"
              width="100"
              :alt="$t('invent.si')"
            />
    ...
    <div v-else class="shimmer-wrapper">
      <div class="shimmer" style="height: 100%" />
    </div>
  </div>
  <!--main-slider-->
</template>
